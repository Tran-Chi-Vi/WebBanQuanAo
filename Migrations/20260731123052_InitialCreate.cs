    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    RuleId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    AntecedentProductId = table.Column<int>(type: "int", nullable: false),
                    ConsequentProductId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AssociationRules", x => x.RuleId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserBehaviorLogs", x => x.LogId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserBehaviorLogs_UserId",
                table: "UserBehaviorLogs",
                column: "UserId");
